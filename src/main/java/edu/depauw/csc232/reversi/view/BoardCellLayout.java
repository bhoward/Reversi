package edu.depauw.csc232.reversi.view;
...
public class BoardCellLayout extends JPanel {
	 ...
	 * {@value}
	 */
	private static final String RESOURCE_PATH_BLACK_DISC = "/assets/black_disc.png";

	/**
	 * {@value}
	 */
	private static final String RESOURCE_PATH_WHITE_DISC = "/assets/white_disc.png";
	...
	public BoardCellLayout() {
		...
		setVisible(true);
		try {
			whiteDiscImage = ImageIO.read(getClass().getResource(RESOURCE_PATH_WHITE_DISC));
			blackDiscImage = ImageIO.read(getClass().getResource(RESOURCE_PATH_BLACK_DISC));
		} catch (IOException e) {
			e.printStackTrace();
		}
